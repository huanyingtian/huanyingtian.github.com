...
document.addEventListener('DOMContentLoaded',function(ev){
    ;(function(){
        ...
        oUl.addEventListener('touchstart',function(ev){
            ...
            oUl.style.transform='translate3d('+-n*aLi[n].offsetWidth+'px,0,0)';
            oUl.style.WebkitTransform='translate3d('+-n*aLi[n].offsetWidth+'px,0,0)';
            oUl.style.MozTransform='translate3d('+-n*aLi[n].offsetWidth+'px,0,0)';
            oUl.style.MsTransform='translate3d('+-n*aLi[n].offsetWidth+'px,0,0)';
            oUl.style.OTransform='translate3d('+-n*aLi[n].offsetWidth+'px,0,0)';
            ...
            function fnEnd(ev){
                ...
                oUl.style.transiton='1s all ease';
                oUl.style.WebkitTransiton='1s all ease';
                oUl.style.MozTransiton='1s all ease';
                oUl.style.MsTransiton='1s all ease';
                oUl.style.OTransiton='1s all ease';
