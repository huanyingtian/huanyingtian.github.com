...
$m_tpl = M_TEMPLATE."/news_list.tpl";
...
$current=$ajavLoad->news_list($_GET['mod'],$catagory);
$tpl->assign('news_list',$current);
$tpl->assign('title',$catagory);
$tpl->assign('page_title',$catagory);
$tpl->display($m_tpl);
?>