...
$m_tpl = M_TEMPLATE."/page_cate.tpl";
...
$pagecates = $ajavLoad->pagecate_child($_GET['catdir'],$par_title);
// echo($_GET['catdir']);die();
$tpl->assign('pagechild',$pagecates);
$tpl->assign('par_title',$par_title);
$tpl->assign('page_title',$par_title);
$tpl->display($m_tpl);
?>