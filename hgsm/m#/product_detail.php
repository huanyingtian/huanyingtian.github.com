...
$m_tpl = M_TEMPLATE."/product_detail.tpl";
...
$single_product = $ajavLoad->product_detail($_GET['id']);
$tpl->assign('single_product',$ajavLoad->product_detail($_GET['id']));
$tpl->assign('page_title',$single_product['title']);
$tpl->assign('shang',$ajavLoad->shang_pro());
$tpl->display($m_tpl);
?>