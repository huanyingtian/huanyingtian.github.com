...
$m_tpl = M_TEMPLATE."/job_detail.tpl";
...
$single_job = $ajavLoad->job_detail($_GET['id']);
$tpl->assign('single_job',$single_job);
$tpl->assign('page_title',$single_job['title']);
$tpl->assign('shang',$ajavLoad->shang_job());
$tpl->display($m_tpl);
?>