...
$m_tpl = M_TEMPLATE."/case_detail.tpl";
...
$single_case = $ajavLoad->case_detail($_GET['id']);
$tpl->assign('single_case',$single_case);
$tpl->assign('page_title',$single_case['title']);
$tpl->assign('shang',$ajavLoad->shang_case());
$tpl->display($m_tpl);
?>