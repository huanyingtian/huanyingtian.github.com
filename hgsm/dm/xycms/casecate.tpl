...
<!--{if $action eq ""}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：案例管理<span>&gt;</span>案例分类</p></div>
  <div class="main-cont">
    <h3 class="title"><a href="xycms_casecate.php?action=add" class="btn-general">添加分类</a>案例分类</h3>
	<form action="xycms_casecate.php" method="post" name="myform" id="myform" style="margin:0">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table" align="center">
	  ...
	  <tr>
		...
		<th width="8%"><div class="th-gap">案例</div></th>
	  ...
	  <tr onmouseover="overColor(this)" onmouseout="outColor(this)">
		...
		<td align="center"><!--{$volist.casecount}--></td>
		<td align="center"><!--{$volist.timeline|date_format:"%Y/%m/%d"}--></td>
		<td align="center"><a href="xycms_casecate.php?action=edit&id=<!--{$volist.cid}-->&page=<!--
{$page}-->" class="icon-set">修改</a>&nbsp;&nbsp;<a href="xycms_casecate.php?action=del&id=<!--{$volist.cid}-->" onclick="{if(confirm('确定要删除该信息?')){return true;} return false;}" class="icon-del">删除</a></td>
	  </tr>
	  <!--{foreachelse}-->
      <tr>
...
<!--{if $action eq "add"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：案例管理<span>&gt;</span>添加案例分类</p></div>
  <div class="main-cont">
	<h3 class="title title_padding"><a href="xycms_casecate.php" class="btn-general">返回列表</a><span class="pro_hover">案例分类基本信息</span><span>案例分类配置信息</span></h3>
    <form name="myform" id="myform" method="post" action="xycms_casecate.php" onsubmit='return checkform();' >
	  ...
	  <tr>
	   <th>样式图标：<span class="f_red"></span></th> 
		<td>
		  ...
		  <iframe id='iframe_t' class="iframe_t1" frameborder='0' scrolling='no' width='450' height='25' src='upload_input.php?filepath=case&is_thumb=2'></iframe>	  	
		</td>
	  </tr>
	  <tr>
	   <th>栏目banner：<span class="f_red"></span></th> 
		<td>
		  ...
		  <img class='upload_img' />
		  <a href="javascript:void(0)" class="pic_remove">删除</a>
		  <iframe id='iframe_t' frameborder='0' scrolling='no' width='450' height='25' src='upload_input.php?filepath=case&is_thumb=2&index=2'></iframe>	  	
		</td>
	  </tr>
	  <tr>
...
<div class="main-wrap">
  ...
  <div class="main-cont">
	<h3 class="title title_padding"><a href="xycms_casecate.php?<!--{$comeurl}-->" class="btn-general">返回列表</a><span class="pro_hover">案例分类基本信息</span><span>案例分类配置信息</span></h3>
    <form name="myform" id="myform" method="post" action="xycms_casecate.php" onsubmit='return checkform();' >
	...
	<table class='table_form'>
	  ...
	  <tr>
		...
		<td>
		  ...
		  <iframe id='iframe_t' frameborder='0' scrolling='no' width='450' height='25' src='upload_input.php?filepath=case&is_thumb=2'></iframe>
		  <script type="text/javascript">
		   var t = "<!--{$cate.img}-->";
		    if(t != ''){
