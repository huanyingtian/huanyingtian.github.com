...
<!--{if $action eq ""}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：门店中心<span>&gt;</span>门店分类</p></div>
  <div class="main-cont">
    <h3 class="title"><a href="xycms_mapcate.php?action=add" class="btn-general">添加分类</a>门店分类</h3>
	<form action="xycms_mapcate.php" method="post" name="myform" id="myform" style="margin:0">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table" align="center">
	  ...
	  <tr>
		...
		<th width="10%"><div class="th-gap">时间</div></th>
	  ...
	  <tr onmouseover="overColor(this)" onmouseout="outColor(this)">
		...
		<td align="center"><a href="xycms_mapcate.php?action=edit&id=<!--{$volist.cid}-->&page=<!--{$page}-->" class="icon-set">修改</a>&nbsp;&nbsp;<a href="xycms_mapcate.php?action=del&id[]=<!--{$volist.cid}-->" onClick="{if(confirm('确定要删除该信息?')){return true;} return false;}" class="icon-del">删除</a></td>
	  </tr>
	  <!--{foreachelse}-->
      <tr>
...
<!--{if $action eq "add"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：门店中心<span>&gt;</span>添加门店分类</p></div>
  <div class="main-cont">
	<h3 class="title"><a href="xycms_mapcate.php" class="btn-general">返回列表</a>添加概况分类</h3>
    <form name="myform" id="myform" method="post" action="xycms_mapcate.php" onsubmit='return checkform();' >
	...
	<table class='table_form'>
	  ...
	  <tr>
		...
		<td><input type="text" name="catdir" class="input-s" value="<!--{$catdir}-->" /></td>
	  </tr>
	  <tr>
...
<div class="main-wrap">
  <div class="path"><p>当前位置：门店中心<span>&gt;</span>门店分类</p></div>
  <div class="main-cont">
	<h3 class="title"><a href="xycms_mapcate.php?<!--{$comeurl}-->" class="btn-general">返回列表</a>门店分类</h3>
    <form name="myform" id="myform" method="post" action="xycms_mapcate.php" onsubmit='return checkform();' >
