...
window.onload=function(){
    ...
    for(i=1;i<=NUM;i++){
        ...
        oImg.src='../image/thumbs/'+i+'.jpg';
    }
};

function loadedSucc(){
    var oParent=document.querySelector('.div1');
    var iNow=-1;
    ...
    for(var j=0;j<ROW;j++){
        for(var i=0;i<COL;i++,k++){
            ...
            oDiv.zns_bg='url(../image/thumbs/'+k+'.jpg)';
            oDiv.zns_row=j;
            oDiv.zns_col=i;
            ...
            aDiv[ii].onclick=function (){
                ...
                if(clicked){
                    ...
                    (function (){
                        ...
                        for(i=0;i<aDiv.length;i++){
                            var oSpan=aDiv[i].getElementsByTagName('span')[0];
                            oSpan.style.background='url(../image/pw'+_this.index+'.jpg) '+-aDiv[i].zns_col*dw+'px '+-aDiv[i].zns_row*dh+'px';
    ...
    oPrev.onclick=oNext.onclick=function (){
        ...
        var timer=setInterval(function(){
            var item=arr.pop();
            aDiv[item].getElementsByTagName('span')[0].style.background='url(../image/pw'+(iNow+1)+'.jpg) '+-aDiv[item].zns_col*dw+'px '+-aDiv[item].zns_row*dh+'px';
